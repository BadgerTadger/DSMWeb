...
public static class Common
{
    ...
    //public static string GetLinkedShowList(string show_ID)
    //{
    //    string showList = string.Format("<ids><id value='{0}' />", show_ID);
    ...
    //        linkedShowList = linkedShows.GetLinked_ShowsByParent_ID(newShow_ID);
    //        foreach (LinkedShows row in linkedShowList)
    //        {
    //            showList += string.Format("<id value='{0}' />", row.Child_Show_ID.ToString());
    //        }            
    //    }
    //    showList += "</ids>";
    //    return showList;
